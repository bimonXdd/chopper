...
int main(int argc, char *argv[]) {
    ...
    win = glfwCreateWindow(static_cast<int>(screenWidth), static_cast<int>(screenHeight), "UV Mapping", NULL, NULL);
    ...
    textureHandles.push_back(load_texture(GL_TEXTURE_2D, GL_RGB, ADD_ROOT("data/stripeTexture.png")));
    textureHandles.push_back(load_texture(GL_TEXTURE_2D, GL_RGBA, ADD_ROOT("data/sasuke256.png")));
    textureHandles.push_back(load_texture(GL_TEXTURE_2D, GL_RGB, ADD_ROOT("data/ut256.png")));
    textureHandles.push_back(load_texture(GL_TEXTURE_2D, GL_RGB, ADD_ROOT("data/brickTexture.jpg")));
    ...
    while (!glfwWindowShouldClose(win)) {
        ...
        lightPosition.x = static_cast<float>(0.8 * sin(glfwGetTime())); //Move our light on a trajectory
        lightPosition.y = static_cast<float>(0.5 * cos(glfwGetTime()));
        lightPosition.z = static_cast<float>(0.1 * sin(glfwGetTime()) + 0.3);
